    ...
    <div className="flex flex-col w-full p-4">
      ...
      {sortedPosts.length > 0 ? (
        sortedPosts.map((post, index) => (
          <div
            key={index}
            className="border cursor-default border-gray-300 p-4 mb-4 rounded-md shadow-md hover:shadow-2xl hover:border-gray-500 transition duration-300"
          >
      ...
      <div className="mb-4 border border-gray-300 rounded-md shadow-md ">
        ...
        <ul className="list-none p-4 ">
          <li className="mb-2 flex justify-around">
            <div>Robin621k</div> <div className="text-right">❤ 120</div>
          </li>
