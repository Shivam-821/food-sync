...
const InputSection = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form Submitted:", foodItems);
  };
      ...
      <div className="p-5 flex flex-col justify-center items-center relative">
        ...
        <form onSubmit={handleSubmit} className="p-4 pl-1 pr-1 bg-gray-800/70 mt-8 rounded-[40px] shadow-md w-[1000px]">
            ...
            <div key={index} className="flex justify-evenly items-center mb-4">
              <div className="relative">
                <input
                  ...
                  placeholder=" "
                />
                <label className={`absolute cursor-text -z-0 left-2 top-1 text-gray-400 transition-all peer-placeholder-shown:top-1/5 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-300 peer-focus:top-0 peer-focus:text-xs peer-focus:text-blue-500 ${foodItems.name !== "" ? "top-0 text-xs text-gray-400" : ""} `}>
                  Name Of Food
                </label>
              </div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder=" "
                />
                <label  className={`absolute cursor-text -z-0 left-2 top-1 text-gray-400 transition-all peer-placeholder-shown:top-1/5 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-300 peer-focus:top-0 peer-focus:text-xs peer-focus:text-blue-500 ${foodItems.quantity !== "" ? "top-0 text-xs text-gray-400" : ""} `}>
                  Quantity
                </label>
              </div>
          ...
          <div className='flex justify-center'>
            ...
            {/* Submit Button */}
            <button type="submit" className="mt-4 px-4 py-2 bg-blue-500/90 text-white cursor-pointer rounded-md">
              Submit
            </button>
          </div>
        </form>
