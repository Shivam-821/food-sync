      ...
      <div className="signup-box">
        ...
        <form>
          <div className="input-box">
            ...
            <input type="text" placeholder="Company Name" onChange={handleChange} name="companyName" value={formData.companyName} required />
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Phone Number" name="phone" onChange={handleChange} value={formData.phone} required />
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <input type="text" placeholder="Location" onChange={handleChange}  required />
          </div>
          <div className="input-box">
            <FaRecycle className="icon" />
            <input type="text" placeholder="Upcycling Methods" name="upcyclingMethods" onChange={handleChange} value={formData.upcyclingMethods} required />
          </div>
