                ...
                <motion.div variants={itemVariants}>
                  <div className="relative">
                    ...
                    <select
                      ...
                      onBlur={() => setActiveField(null)}
                      className={`consumer-input appearance-none ${
