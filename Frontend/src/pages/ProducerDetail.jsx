  ...
  return (
    <div className="bg-gradient-to-br from-yellow-100 to-yellow-300 min-h-screen font-sans">
      ...
      <div className="max-w-6xl mx-auto py-16 px-6">
        ...
        >
          <img
            className="h-40 w-40 rounded-full border-4 border-gray-300 shadow-md hover:scale-105 transition-transform overflow-auto"
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Passionate about reducing food waste and promoting sustainability.
            </p>
          </div>
        </motion.div>
        ...
        <div className="mt-10 space-y-8">
          ...
          >
            ...
            <p className="text-gray-700">
              We have donated over 10,000 meals to local charities and food
          ...
          >
            ...
            />
            <p className="text-gray-600 mt-2">
              Rated 4.5/5 based on 200 reviews from our partners.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-5">
            {["Burger", "Vegetables", "Chocolate", "Pizza"].map(
              (item, index) => (
                <motion.div
                  key={index}
        ...
        >
          ...
          <p className="text-gray-700">
            ...
            <a href="mailto:contact@foodsync.com" className="text-blue-600">
              contact@foodsync.com
            </a>
          </p>
          <p className="text-gray-700">
